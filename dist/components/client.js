...
//   ): void;
// }
var initFlagsClient = function (env, options, user) {
    return new Promise(function (resolve) {
        var ld = new LaunchDarkly();
        ld.configure(env, options, user).then(function () { return __awaiter(_this, void 0, void 0, function () {
...
exports.initFlagsClient = initFlagsClient;
